            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Jurusan
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Jurusan</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="jurusan-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            ...
            if (save_method == 'add') url = "{{ url('jurusan') }}";
            else url = "{{ url('jurusan') . '/' }}" + id;
