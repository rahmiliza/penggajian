    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Golongan</h3>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Golongan
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Golongan</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="golongan-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    table = $('#golongan-table').DataTable({
        processing: true,
        serverSide: true,
        bLengthChange: true,
        iDisplayLength: 5,
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            ...
            if (save_method == 'add') url = "{{ url('golongan') }}";
            else url = "{{ url('golongan') . '/' }}" + id;
