    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Pangkat</h3>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Pangkat
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Pangkat</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="pangkat-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            var id = $('#id_pangkat').val();
            if (save_method == 'add') url = "{{ url('pangkat') }}";
            else url = "{{ url('pangkat') . '/' }}" + id;
