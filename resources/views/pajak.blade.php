            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Pajaklist
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Pajak</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="pajak-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            var id = $('#id_pajak').val();
            if (save_method == 'add') url = "{{ url('pajak') }}";
            else url = "{{ url('pajak') . '/' }}" + id;
