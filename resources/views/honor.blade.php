    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Honor</h3>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Honor list
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Honor</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="honor-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            var id = $('#id_honor').val();
            if (save_method == 'add') url = "{{ url('honor') }}";
            else url = "{{ url('honor') . '/' }}" + id;
...
function editForm(id) {
    ...
    $.ajax({
        url: "{{ url('honor') }}" + '/' + id + "/edit",
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('#modal-form').modal('show');
            $('.modal-title').text('Edit Meal');
            $('#id_honor').val(data.id_honor);
